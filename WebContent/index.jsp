...
<% 
	...
	if (islogin==null || islogin.equals("0")) {
		...
		if (conn == null){
			...
			conn.fillResult(resultvector, location,beginDate,endDate);
			System.out.println("size : " + resultvector.size());
			conn.closeStatement();
		}
		
		Collections.sort(resultvector);		//按机床名排序
            	...
            	<div class="col-md-8">
            		<div class="panel panel-default">
            			...
            			<div class="panel-body"  >
            				<div class="row">
	            				<form action="index.jsp" method="post" onsubmit="disable_searchbtn();">
	            					<div class="row">
            		...
            		<div class="col-md-1">
            			<div class="panel panel-default">
            				...
            				<div class="panel-body">
            					...
            					<div class="row">
            						<form action="result.jsp" method="post" name="result">
